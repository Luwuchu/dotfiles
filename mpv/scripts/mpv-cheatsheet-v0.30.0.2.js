...
})()(
	{
		1: [
			function (require, module, exports) {
				...
				Assdraw.prototype.bezierCurve = function (
					x1,
					y1,
					x2,
					y2,
				...
				Assdraw.prototype.hexagonCw = function (
					x0,
					y0,
					x1,
					y1,
				...
				Assdraw.prototype.hexagonCcw = function (
					x0,
					y0,
					x1,
					y1,
				...
				Assdraw.prototype.roundRectCw = function (
					ass,
					x0,
					y0,
					x1,
				...
				Assdraw.prototype.roundRectCcw = function (
					ass,
					x0,
					y0,
					x1,
			...
			function (require, module, exports) {
				...
				var shortcuts = [
					{
						...
						shortcuts: [
							...
							{
								keys: '[Shift] PGDWN / PGUP',
								effect: 'Seek by 10 minutes',
							},
							{
								keys: '[Shift] ← / →',
								effect: 'Seek by 1 second (exact)',
							},
							{
								keys: '[Shift] ↓ / ↑',
								effect: 'Seek by 5 seconds (exact)',
							},
							{
								keys: '[Ctrl] ← / →',
								effect: 'Seek by subtitle',
							},
							{
								keys: '[Shift] BACKSPACE',
								effect: 'Undo last seek',
							},
							{
								keys: '[Ctrl+Shift] BACKSPACE',
								effect: 'Mark current position',
							},
							{ keys: 'l', effect: 'Set/clear A-B loop points' },
							{ keys: 'L', effect: 'Toggle infinite looping' },
							{
								keys: 'PGDWN / PGUP',
								effect: 'Previous/next chapter',
							},
							{
								keys: '< / >',
								effect: 'Go backward/forward in the playlist',
							},
							{
								keys: 'ENTER',
								effect: 'Go forward in the playlist',
							},
					...
					},
					{
						...
						shortcuts: [
							...
							{
								keys: '[ / ]',
								effect: 'Decrease/increase speed [10%]',
							},
					...
					},
					{
						...
						shortcuts: [
							{
								keys: '[Ctrl+Shift] ← / →',
								effect: 'Adjust subtitle delay [subtitle]',
							},
							{
								keys: 'z / Z',
								effect: 'Adjust subtitle delay [0.1sec]',
							},
							{ keys: 'v', effect: 'Toggle subtitle visibility' },
							{
								keys: 'u',
								effect: 'Toggle subtitle style overrides',
							},
							{
								keys: 'V',
								effect: 'Toggle subtitle VSFilter aspect compatibility mode',
							},
							{ keys: 'r / R', effect: 'Move subtitles up/down' },
							{ keys: 'j / J', effect: 'Cycle subtitle' },
							{
								keys: 'F9',
								effect: 'Show audio/subtitle list [UI]',
							},
						],
					},
					{
						...
						shortcuts: [
							...
							{
								keys: '/ / *',
								effect: 'Decrease/increase volume',
							},
							{
								keys: '9 / 0',
								effect: 'Decrease/increase volume',
							...
							{
								keys: '[Ctrl] - / +',
								effect: 'Decrease/increase audio delay [0.1sec]',
							},
							{
								keys: 'F9',
								effect: 'Show audio/subtitle list [UI]',
					...
					},
					{
						...
						shortcuts: [
							...
							{
								keys: '[Ctrl] h',
								effect: 'Toggle hardware video decoding',
							},
							{
								keys: 'w / W',
								effect: 'Decrease/increase pan-and-scan range',
							},
							{ keys: '[Alt] - / +', effect: 'Zoom out/in' },
							{
								keys: '[Alt] ARROWS',
								effect: 'Move the video rectangle',
							},
							{
								keys: '[Alt] BACKSPACE',
								effect: 'Reset pan/zoom',
							},
							{
								keys: '1 / 2',
								effect: 'Decrease/increase contrast',
							},
							{
								keys: '3 / 4',
								effect: 'Decrease/increase brightness',
							},
							{
								keys: '5 / 6',
								effect: 'Decrease/increase gamma',
							},
							{
								keys: '7 / 8',
								effect: 'Decrease/increase saturation',
							},
						],
					},
					{
						...
						shortcuts: [
							...
							{
								keys: 'S',
								effect: 'Take a screenshot without subtitles',
							},
							{
								keys: '[Ctrl] s',
								effect: 'Take a screenshot as rendered',
							},
						],
					},
					{
						...
						shortcuts: [
							...
							{
								keys: '[Command] f',
								effect: 'Toggle fullscreen [macOS]',
							},
							{ keys: 'ESC', effect: 'Exit fullscreen' },
							{ keys: 'T', effect: 'Toggle stay-on-top' },
							{
								keys: '[Alt] 0',
								effect: 'Resize window to 0.5x [macOS]',
							},
							{
								keys: '[Alt] 1',
								effect: 'Reset window size [macOS]',
							},
							{
								keys: '[Alt] 2',
								effect: 'Resize window to 2x [macOS]',
							},
						],
					},
					{
				...
				function renderCategory(category) {
					...
					category.shortcuts.forEach(function (shortcut) {
						if (shortcut.keys.length > maxKeysLength)
							maxKeysLength = shortcut.keys.length
					})
					category.shortcuts.forEach(function (shortcut) {
						var padding = repeat(
							' ',
						...
						lines.push(
							assdraw.escape(
								shortcut.keys + padding + ' ' + shortcut.effect
							)
						)
					})
					return lines
